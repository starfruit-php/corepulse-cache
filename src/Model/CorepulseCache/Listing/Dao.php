...
namespace CorepulseCacheBundle\Model\CorepulseCache\Listing;

use CorepulseCacheBundle\Model;
...
class Dao extends Listing\Dao\AbstractDao
{
    ...
    protected string $tableName = 'corepulse_caches';
    ...
    public function load(): array
    {
        ...
        $objects = [];
        foreach ($list as $id) {
            if ($object = Model\CorepulseCache::getById($id)) {
                $objects[] = $object;
            }
        }
